...
impl BarTracker {
    ...
    fn show_ui_tab(&self, btn: &nwg::Button) {
        if btn == &self.akasha_ui_button {
            ...
            self.akasha_blue_box_label.set_visible(true);
            self.akasha_blue_box.set_visible(true);
            self.akasha_no_blue_box.set_visible(true);
            self.akasha_no_blue_box_label.set_visible(true);
            self.akasha_no_blue_box_button.set_visible(true);
            self.akasha_coronation_ring.set_visible(true);
            self.akasha_coronation_ring_label.set_visible(true);
            self.akasha_coronation_ring_percentage.set_visible(true);
            self.akasha_coronation_rings_button.set_visible(true);
            self.akasha_lineage_ring.set_visible(true);
            self.akasha_lineage_ring_label.set_visible(true);
            self.akasha_lineage_ring_percentage.set_visible(true);
            self.akasha_lineage_rings_button.set_visible(true);
            self.akasha_intricacy_ring.set_visible(true);
            self.akasha_intricacy_ring_label.set_visible(true);
            self.akasha_intricacy_ring_percentage.set_visible(true);
            self.akasha_intricacy_rings_button.set_visible(true);
            self.akasha_gold_bar.set_visible(true);
            self.akasha_gold_bar_label.set_visible(true);
            self.akasha_gold_bar_percentage.set_visible(true);
            self.akasha_gold_bars_button.set_visible(true);
            self.pbhl_ui_button.set_enabled(true);
            self.pbhl_blue_box_label.set_visible(false);
            self.pbhl_blue_box.set_visible(false);
            self.pbhl_no_blue_box.set_visible(false);
            self.pbhl_no_blue_box_label.set_visible(false);
            self.pbhl_no_blue_box_button.set_visible(false);
            self.pbhl_coronation_ring.set_visible(false);
            self.pbhl_coronation_ring_label.set_visible(false);
            self.pbhl_coronation_ring_percentage.set_visible(false);
            self.pbhl_coronation_rings_button.set_visible(false);
            self.pbhl_lineage_ring.set_visible(false);
            self.pbhl_lineage_ring_label.set_visible(false);
            self.pbhl_lineage_ring_percentage.set_visible(false);
            self.pbhl_lineage_rings_button.set_visible(false);
            self.pbhl_intricacy_ring.set_visible(false);
            self.pbhl_intricacy_ring_label.set_visible(false);
            self.pbhl_intricacy_ring_percentage.set_visible(false);
            self.pbhl_intricacy_rings_button.set_visible(false);
            self.pbhl_gold_bar.set_visible(false);
            self.pbhl_gold_bar_label.set_visible(false);
            self.pbhl_gold_bar_percentage.set_visible(false);
            self.pbhl_gold_bars_button.set_visible(false);
            self.gohl_ui_button.set_enabled(true);
            self.gohl_blue_box_label.set_visible(false);
            self.gohl_blue_box.set_visible(false);
            self.gohl_no_blue_box.set_visible(false);
            self.gohl_no_blue_box_label.set_visible(false);
            self.gohl_no_blue_box_button.set_visible(false);
            self.gohl_coronation_ring.set_visible(false);
            self.gohl_coronation_ring_label.set_visible(false);
            self.gohl_coronation_ring_percentage.set_visible(false);
            self.gohl_coronation_rings_button.set_visible(false);
            self.gohl_lineage_ring.set_visible(false);
            self.gohl_lineage_ring_label.set_visible(false);
            self.gohl_lineage_ring_percentage.set_visible(false);
            self.gohl_lineage_rings_button.set_visible(false);
            self.gohl_intricacy_ring.set_visible(false);
            self.gohl_intricacy_ring_label.set_visible(false);
            self.gohl_intricacy_ring_percentage.set_visible(false);
            self.gohl_intricacy_rings_button.set_visible(false);
            self.gohl_gold_bar.set_visible(false);
            self.gohl_gold_bar_label.set_visible(false);
            self.gohl_gold_bar_percentage.set_visible(false);
            self.gohl_gold_bars_button.set_visible(false);
            self.gohl_steel_bar.set_visible(false);
            self.gohl_steel_bar_label.set_visible(false);
            self.gohl_steel_bar_percentage.set_visible(false);
            self.gohl_steel_bars_button.set_visible(false);
            self.hosts_ui_button.set_visible(false);
        } else if btn == &self.pbhl_ui_button {
            self.pbhl_ui_button.set_enabled(false);
            self.pbhl_blue_box_label.set_visible(true);
            self.pbhl_blue_box.set_visible(true);
            self.pbhl_no_blue_box.set_visible(true);
            self.pbhl_no_blue_box_label.set_visible(true);
            self.pbhl_no_blue_box_button.set_visible(true);
            self.pbhl_coronation_ring.set_visible(true);
            self.pbhl_coronation_ring_label.set_visible(true);
            self.pbhl_coronation_ring_percentage.set_visible(true);
            self.pbhl_coronation_rings_button.set_visible(true);
            self.pbhl_lineage_ring.set_visible(true);
            self.pbhl_lineage_ring_label.set_visible(true);
            self.pbhl_lineage_ring_percentage.set_visible(true);
            self.pbhl_lineage_rings_button.set_visible(true);
            self.pbhl_intricacy_ring.set_visible(true);
            self.pbhl_intricacy_ring_label.set_visible(true);
            self.pbhl_intricacy_ring_percentage.set_visible(true);
            self.pbhl_intricacy_rings_button.set_visible(true);
            self.pbhl_gold_bar.set_visible(true);
            self.pbhl_gold_bar_label.set_visible(true);
            self.pbhl_gold_bar_percentage.set_visible(true);
            self.pbhl_gold_bars_button.set_visible(true);
            self.akasha_ui_button.set_enabled(true);
            self.akasha_blue_box_label.set_visible(false);
            self.akasha_blue_box.set_visible(false);
            self.akasha_no_blue_box.set_visible(false);
            self.akasha_no_blue_box_label.set_visible(false);
            self.akasha_no_blue_box_button.set_visible(false);
            self.akasha_coronation_ring.set_visible(false);
            self.akasha_coronation_ring_label.set_visible(false);
            self.akasha_coronation_ring_percentage.set_visible(false);
            self.akasha_coronation_rings_button.set_visible(false);
            self.akasha_lineage_ring.set_visible(false);
            self.akasha_lineage_ring_label.set_visible(false);
            self.akasha_lineage_ring_percentage.set_visible(false);
            self.akasha_lineage_rings_button.set_visible(false);
            self.akasha_intricacy_ring.set_visible(false);
            self.akasha_intricacy_ring_label.set_visible(false);
            self.akasha_intricacy_ring_percentage.set_visible(false);
            self.akasha_intricacy_rings_button.set_visible(false);
            self.akasha_gold_bar.set_visible(false);
            self.akasha_gold_bar_label.set_visible(false);
            self.akasha_gold_bar_percentage.set_visible(false);
            self.akasha_gold_bars_button.set_visible(false);
            self.gohl_ui_button.set_enabled(true);
            self.gohl_blue_box_label.set_visible(false);
            self.gohl_blue_box.set_visible(false);
            self.gohl_no_blue_box.set_visible(false);
            ...
            self.gohl_blue_box_label.set_visible(true);
            self.gohl_blue_box.set_visible(true);
            self.gohl_no_blue_box.set_visible(true);
            self.gohl_no_blue_box_label.set_visible(true);
            self.gohl_no_blue_box_button.set_visible(true);
            self.gohl_coronation_ring.set_visible(true);
            self.gohl_coronation_ring_label.set_visible(true);
            self.gohl_coronation_ring_percentage.set_visible(true);
            self.gohl_coronation_rings_button.set_visible(true);
            self.gohl_lineage_ring.set_visible(true);
            self.gohl_lineage_ring_label.set_visible(true);
            self.gohl_lineage_ring_percentage.set_visible(true);
            self.gohl_lineage_rings_button.set_visible(true);
            self.gohl_intricacy_ring.set_visible(true);
            self.gohl_intricacy_ring_label.set_visible(true);
            self.gohl_intricacy_ring_percentage.set_visible(true);
            self.gohl_intricacy_rings_button.set_visible(true);
            self.gohl_gold_bar.set_visible(true);
            self.gohl_gold_bar_label.set_visible(true);
            self.gohl_gold_bar_percentage.set_visible(true);
            self.gohl_gold_bars_button.set_visible(true);
            self.gohl_steel_bar.set_visible(true);
            self.gohl_steel_bar_label.set_visible(true);
            self.gohl_steel_bar_percentage.set_visible(true);
            self.gohl_steel_bars_button.set_visible(true);
            self.hosts_ui_button.set_visible(false);
